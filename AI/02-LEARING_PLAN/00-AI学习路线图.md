...
> 面向 **AI 应用 / Agent 工程师**（不是模型研究员）。把 [[核心概念|核心概念库]] 里的 **38** 个概念排成一条可执行学习路径。
>
> 四阶段：
...
> 目标：**能解释「LLM 是什么、怎么训、Tokenizer 与 Attention 在干什么」**，再读技术报告与 [[Transformer架构]] 不犯迷糊。  
> 索引：[[核心概念]] 第 0 章「基础与 LLM 概论」。

按顺序读（每天 1–2 篇即可）：

1. [[AI/00-AI知识体系/概念/00-基础与LLM概论/01-什么是LLM|什么是LLM]]
2. [[AI/00-AI知识体系/概念/00-基础与LLM概论/02-神经网络与反向传播|神经网络与反向传播]]
3. [[AI/00-AI知识体系/概念/00-基础与LLM概论/03-表示学习-从词嵌入到上下文|表示学习-从词嵌入到上下文]]
4. [[AI/00-AI知识体系/概念/00-基础与LLM概论/04-语言模型与Next-Token-Prediction|语言模型与 Next-Token Prediction]]
5. [[AI/00-AI知识体系/概念/00-基础与LLM概论/05-Tokenizer与分词|Tokenizer与分词]]
6. [[AI/00-AI知识体系/概念/00-基础与LLM概论/06-从RNN-CNN到Attention简史|从 RNN/CNN 到 Attention 简史]]
7. [[AI/00-AI知识体系/概念/00-基础与LLM概论/07-注意力机制直觉-QKV|注意力机制直觉-QKV]] → 接着读 [[Transformer架构]]
...
- [[核心概念]] —— 38 篇概念库的主索引（MOC，含 7 篇基础概论）
