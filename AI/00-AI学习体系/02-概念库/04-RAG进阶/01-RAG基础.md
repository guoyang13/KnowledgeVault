...
- **Hybrid Search**：稠密向量 + BM25 / SPLADE 关键词混合（见 [[AI/00-AI学习体系/02-概念库/04-RAG进阶/02-GraphRAG与Agentic RAG|GraphRAG与Agentic RAG]]）。
...
- 选型、相似度、评测和常见坑见 [[AI/00-AI学习体系/02-概念库/04-RAG进阶/03-Embedding模型与向量检索|Embedding模型与向量检索]]。
...
- [[AI/00-AI学习体系/02-概念库/06-工程生态/08-Spring-AI-RAG处理与基础设施|Spring-AI-RAG处理与基础设施]] — Spring AI 侧 RAG 实现
- [[AI/00-AI学习体系/02-概念库/06-工程生态/09-RAG实战-interview-guide全链路|RAG实战-interview-guide全链路]] — 项目落地
