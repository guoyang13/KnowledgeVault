...
## 记忆分层
- **Working Memory**：当前对话的上下文窗口，受 [[AI/00-AI学习体系/02-概念库/01-模型层/07-上下文与KV Cache|context window]] 限制。
...
## 实现方式
- **向量检索**：把对话/事件嵌入向量库，按相似度召回；底层见 [[AI/00-AI学习体系/02-概念库/04-RAG进阶/03-Embedding模型与向量检索|Embedding模型与向量检索]]。
...
- **避免污染**：恶意输入可能注入"虚假记忆"，参见 [[AI/00-AI学习体系/02-概念库/07-安全治理/01-Prompt Injection与Agent安全|Prompt Injection与Agent安全]]。
