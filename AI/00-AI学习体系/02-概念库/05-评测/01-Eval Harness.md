...
- 区别于 [[AI/00-AI学习体系/02-概念库/03-Agent系统/05-Agent Harness|Agent Harness]]（那个是包装 LLM 做 Agent；这个是包装跑评测）。
...
- [[AI/00-AI学习体系/02-概念库/05-评测/03-LLM-as-a-Judge|LLM-as-a-Judge]]（→ 在 [[AI/00-AI学习体系/02-概念库/05-评测/02-Benchmark集合|Benchmark集合]] 内）
