...
> **Attention** 让序列中每个位置根据与其它位置的相关性，**加权汇总**信息。读懂 Q/K/V，再读 [[AI/00-AI学习体系/02-概念库/01-模型层/01-Transformer架构|Transformer架构]] 会轻松很多。
...
- 催生：FlashAttention、GQA/MLA、滑动窗口、[[AI/00-AI学习体系/02-概念库/01-模型层/06-新架构-SSM与Mamba|SSM]] 等
- 推理时用 **KV Cache** 缓存历史 K/V：见 [[AI/00-AI学习体系/02-概念库/01-模型层/07-上下文与KV Cache|上下文与KV Cache]]
...
- 架构总览：[[AI/00-AI学习体系/02-概念库/01-模型层/01-Transformer架构|Transformer架构]]
- 简史：[[AI/00-AI学习体系/02-概念库/00-基础与LLM概论/06-从RNN-CNN到Attention简史|从 RNN/CNN 到 Attention 简史]]
- 表示：[[AI/00-AI学习体系/02-概念库/00-基础与LLM概论/03-表示学习-从词嵌入到上下文|表示学习-从词嵌入到上下文]]
- 位置编码：RoPE 等在 [[AI/00-AI学习体系/02-概念库/01-模型层/01-Transformer架构|Transformer架构]] 中展开
