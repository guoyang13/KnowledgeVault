...
- **[[AI/00-AI学习体系/02-概念库/03-Agent系统/05-Agent Harness|Agent Harness]] 质量**：同模型 + 不同 harness，SWE-bench 能差 10–30 个点。
...
- **[[AI/00-AI学习体系/02-概念库/03-Agent系统/06-MCP协议|MCP协议]]**：标准化外部工具接入。

## 评测
- **SWE-bench Verified**：真实 GitHub issue。
- **Terminal-Bench**、**LiveCodeBench**、**HumanEval+**。
- 见 [[AI/00-AI学习体系/02-概念库/05-评测/02-Benchmark集合|Benchmark集合]]。
