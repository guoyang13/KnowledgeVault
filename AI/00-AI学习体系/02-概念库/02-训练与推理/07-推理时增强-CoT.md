...
## 单次增强
- **CoT（Chain-of-Thought）**：让模型"逐步思考"再回答。可显式 prompt，也可由 [[AI/00-AI学习体系/02-概念库/01-模型层/03-推理模型|推理模型]] 内置。
...
- **MCTS-LLM**：用 [[AI/00-AI学习体系/02-概念库/02-训练与推理/03-PRM与ORM|PRM与ORM]] 当价值函数做蒙特卡洛树搜索。
...
- 现代 [[AI/00-AI学习体系/02-概念库/01-模型层/03-推理模型|推理模型]] 已把这些"训练进去"，开发者只需调 `reasoning_effort` 即可。
