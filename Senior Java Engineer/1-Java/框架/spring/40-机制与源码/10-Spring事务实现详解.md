...
type: canonical
status: reviewed
topic: Spring declarative transaction
source_version: 6.2.x
---

# Spring 事务实现详解

> 导航：[[00-Spring-Framework核心机制-学习导航]] · **40 · 机制与源码** · 事务机制
>
> 前置：[[8-Spring-AOP代理创建详解]] · [[2-扩展点层-BeanPostProcessor详解]]
>
> 关联：[[2-Bean加载原理与源码阅读路径]] · [[1-源码调试与断点指南]]
>
...
与 [[8-Spring-AOP代理创建详解#六、代理在 doCreateBean 中的时机与替换]] 相同：
...
与 Bean 生命周期的衔接见 [[8-Spring-AOP代理创建详解]]：代理在 `initializeBean` 的 `postProcessAfterInitialization` 创建；事务拦截在**运行时**每次方法调用时触发。
...
配合 [[1-源码调试与断点指南]]、[[8-Spring-AOP代理创建详解#十、源码定位 · 断点 · 误区]]。
...
| 上一篇 | 下一篇 |
|--------|--------|
| [[8-Spring-AOP代理创建详解]] | [[9-Bean 销毁机制详解]] |
