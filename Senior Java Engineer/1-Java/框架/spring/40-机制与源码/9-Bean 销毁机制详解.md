...
type: canonical
status: reviewed
topic: Spring Bean destruction
source_version: 6.2.x
---

# Bean 销毁机制详解

> 导航：[[00-Spring-Framework核心机制-学习导航]] · **40 · 机制与源码** · Bean 销毁
>
> 源码：
...
>
> 前置：[[2-Bean加载原理与源码阅读路径]] · [[2-扩展点层-BeanPostProcessor详解]]
>
> 关联：[[3-refresh方法详解]] · [[4-容器层-BeanFactory接口体系详解]] · [[8-Spring-AOP代理创建详解]]
...
与 `refresh` 异常回滚的关系（[[3-refresh方法详解]]）：
...
| 与 AOP 分工一致 | 代理负责拦截；销毁负责释放 target 资源 → [[8-Spring-AOP代理创建详解]] |
...
配合 [[1-源码调试与断点指南]]、[[2-扩展点层-BeanPostProcessor详解#八、DestructionAwareBeanPostProcessor]]。
