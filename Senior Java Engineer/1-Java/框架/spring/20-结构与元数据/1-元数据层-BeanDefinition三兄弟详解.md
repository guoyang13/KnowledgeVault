...
type: canonical
status: reviewed
topic: Spring BeanDefinition
source_version: 6.2.x
---

# BeanDefinition 三兄弟详解

> 导航：[[00-Spring-Framework核心机制-学习导航]] · **20 · 结构与元数据** · 元数据层 · 前置：[[4-接口地图-IoC与DI重要接口大全]] · [[2-速查-IoC与DI核心整合速查]]
>
...
| `isFactoryBean` | 是否为 FactoryBean（详见 [[5-工厂Bean-BeanFactory与FactoryBean的区别]]） |
| `stale` | 定义过期，需重新合并 |
...
> Reader / Scanner 详解 → [[2-元数据层-AnnotatedBeanDefinitionReader与组件注册详解]]
...
| 上一篇 | 下一篇 |
|--------|--------|
| [[4-接口地图-IoC与DI重要接口大全]] | [[2-元数据层-AnnotatedBeanDefinitionReader与组件注册详解]] |
