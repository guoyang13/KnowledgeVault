...
> 导航：[[00-Spring-Bean加载-学习导航]] · **上篇 01–15** · 元数据层 · 注解扫描与组件注册
>
> 前置：[[06-元数据层-BeanDefinition三兄弟详解]] · [[01-注解入门-配置类与组件类]] · [[02-注解入门-Configuration与Service等注解区别]]
>
> 本地源码：
...
> BFPP / BPP 详解 → [[11-扩展点层-BeanFactoryPostProcessor详解]] · [[12-扩展点层-BeanPostProcessor详解]]
...
> 配置类 vs 组件类角色对比 → [[01-注解入门-配置类与组件类]]
...
| 断点 | 文件 | 看什么 |
|------|------|--------|
| Reader 构造 L119 | `AnnotatedBeanDefinitionReader` | 基础设施 Definition 写入 |
| doRegisterBean L283 | `AnnotatedBeanDefinitionReader` | Class → BeanDefinition |
| registerBeanDefinition L1359 | `DefaultListableBeanFactory` | Map 写入 |
| refresh L619 | `AbstractApplicationContext` | BFPP 解析 @Bean |
...
| 上一篇 | 下一篇 |
|--------|--------|
| [[06-元数据层-BeanDefinition三兄弟详解]] | [[08-注册层-BeanDefinitionRegistry与DefaultListableBeanFactory详解]] |
